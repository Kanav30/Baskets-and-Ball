...
//basketball
 basketball = createSprite(186,570);
 ...
 ground = createSprite(200,645,400,10);
...
//if ball goes out of canvas decrease score
    if(basketball.x < 0 || basketball.x > 400 || basketball.y < 0 || basketball.y > 650){
      score = score - 1;
    }   
    //spawning clouds
     spawnClouds();
  ...
  textSize(27.5);
  text("Move with arrow keys or joystick", 1 , 625);
}
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.x = Math.round(random(10,350))
    cloud.scale = 0.1;
    cloud.velocityY = 3;
